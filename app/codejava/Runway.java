...
public class Runway {
	...
	public Runway(String id,
		...
		this.airport_ref = Objects.requireNonNull(airport_ref); 
		this.airport_ident = Objects.requireNonNull(airport_ident); 
		this.length_ft = Objects.requireNonNull(length_ft); 
		this.width_ft = Objects.requireNonNull(width_ft); 
		this.surface = Objects.requireNonNull(surface); 
		this.lighted = Objects.requireNonNull(lighted); 
		this.closed = Objects.requireNonNull(closed); 
		this.le_ident = Objects.requireNonNull(le_ident); 
		this.le_latitude_deg = Objects.requireNonNull(le_latitude_deg); 
		this.le_longitude_deg = Objects.requireNonNull(le_longitude_deg); 
		this.le_elevation_ft = Objects.requireNonNull(le_elevation_ft); 
		this.le_heading_degT = Objects.requireNonNull(le_heading_degT); 
		this.le_displaced_threshold_ft = Objects.requireNonNull(le_displaced_threshold_ft); 
		this.he_ident = Objects.requireNonNull(he_ident); 
		this.he_latitude_deg = Objects.requireNonNull(he_latitude_deg); 
		this.he_longitude_deg = Objects.requireNonNull(he_longitude_deg); 
		this.he_elevation_ft = Objects.requireNonNull(he_elevation_ft); 
		this.he_heading_degT = Objects.requireNonNull(he_heading_degT); 
		this.he_displaced_threshold_ft = Objects.requireNonNull(he_displaced_threshold_ft);
	}
