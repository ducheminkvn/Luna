...
package controllers.javascript {
  ...
  // @LINE:8
  class ReverseControllerReports(_prefix: => String) {
    ...
    def index: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.ControllerReports.index",
      """
        function() {
  ...
  // @LINE:7
  class ReverseControllerQuery(_prefix: => String) {
    ...
    // @LINE:7
    def index: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.ControllerQuery.index",
      """
        function() {
